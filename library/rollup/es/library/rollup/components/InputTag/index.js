...
const InputTag = (props, ref) => {
    ...
    return (React.createElement("div", { className: cls("input-tag-container", props.className) },
        tagLists.map((tag, idx) => (React.createElement(Tag, { bordered: true, closable: !props.disabled, onClose: (e) => handleTagClear(tag, idx, e), key: v4(), className: "input-tag-tagger" }, tag))),
...
var index = React.forwardRef(InputTag);
